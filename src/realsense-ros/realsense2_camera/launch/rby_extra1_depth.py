...
# DESCRIPTION #
# ----------- #
# Use this launch file to launch the head camera with simple RGB and depth streams.
# The Parameters available for definition in the command line are described in rs_launch.configurable_parameters
# command line example:
# ros2 launch realsense2_camera rby_head_cam_simple.py

"""Launch realsense2_camera node for head camera with RGB and depth streams."""
import os
import yaml
...
# Define the extra1 camera serial number
EXTRA1_CAMERA_SN = "_053422250812"  # Head camera serial number (D455)
...
configurable_parameters = [{'name': 'camera_name',                  'default': 'extra1_camera', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'extra1_camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': f'"{EXTRA1_CAMERA_SN}"', 'description': 'choose device by serial number'},
                           ...
                           {'name': 'pointcloud.enable',            'default': 'true', 'description': 'disable pointcloud'},
                           {'name': 'pointcloud.stream_filter',     'default': '0', 'description': 'texture stream for pointcloud (0=color)'},
                           {'name': 'pointcloud.stream_index_filter','default': '0', 'description': 'texture stream index for pointcloud'},
                           {'name': 'pointcloud.ordered_pc',        'default': 'true', 'description': 'Generate an ordered pointcloud'},
