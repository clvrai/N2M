...
# DESCRIPTION #
# ----------- #
# Use this launch file to launch the right wrist camera.
# The Parameters available for definition in the command line are described in rs_launch.configurable_parameters
# command line example:
# ros2 launch realsense2_camera rby_right_cam.py

"""Launch realsense2_camera node for right camera."""
import os
import yaml
...
# Define the right camera serial number
RIGHT_CAMERA_SN = "427622271135"  # Right camera serial number (D405)
...
configurable_parameters = [{'name': 'camera_name',                  'default': 'right_camera', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'right_camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': f'"{RIGHT_CAMERA_SN}"', 'description': 'choose device by serial number'},
