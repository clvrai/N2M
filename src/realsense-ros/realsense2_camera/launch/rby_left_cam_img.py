...
# DESCRIPTION #
# ----------- #
# Use this launch file to launch the left wrist camera.
# The Parameters available for definition in the command line are described in rs_launch.configurable_parameters
# command line example:
# ros2 launch realsense2_camera rby_left_cam.py

"""Launch realsense2_camera node for left camera."""
import os
import yaml
...
# Define the left camera serial number
LEFT_CAMERA_SN = "409122274689"  # Left camera serial number (D405)
...
configurable_parameters = [{'name': 'camera_name',                  'default': 'left_camera', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'left_camera', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': f'"{LEFT_CAMERA_SN}"', 'description': 'choose device by serial number'},
